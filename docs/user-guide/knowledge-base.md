...
```{figure} /_static/images/usage/knowledge-panel.png
:alt: Knowledge Base Panel
:width: 100%

The Knowledge Base panel showing analysis scripts and documentation.
```
...
- [Workflows](workflows/index.md) - Multi-step calibration workflows
