...
## Purpose
The chat interface provides real-time conversational interaction with AI agents through the QCA, supporting text input, voice input, and streaming responses with human-in-the-loop workflow capabilities.
...
| Message Actions | Buttons | Message Hover | Copy, Edit, Delete, Speak, Feedback | Per-message actions; feedback buttons only for supported observability-traced responses |
...
- Feedback buttons for supported observability-traced assistant responses
