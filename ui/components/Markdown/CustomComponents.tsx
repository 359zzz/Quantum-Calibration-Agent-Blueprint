...
import { ExperimentEmbed } from '@/components/Markdown/ExperimentEmbed';
...
export const getReactMarkDownCustomComponents = (
  ...
  return {
      ...
      experiment: memo(
        (props: any) => <ExperimentEmbed {...props} />,
        (prevProps, nextProps) => isEqual(prevProps['experiment-id'], nextProps['experiment-id']),
      ),
  };
};
